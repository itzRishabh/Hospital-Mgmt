...
public class DoctorUpdateEncounter extends javax.swing.JPanel {
    ...
    public DoctorUpdateEncounter(PatientDirectory patientDirectory, DoctorDirectory doctorDirectory ) {
        initComponents();
        ...
        // TODO add your handling code here:   
            if(checkForNullorEmptyValue()){
                try {
                    ...
                    Logger.getLogger(DoctorUpdateEncounter.class.getName()).log(Level.SEVERE, null, ex);
                }
                 ...
                 for(Encounter e: encounters){
                     ...
                     if(encounterIdInput == e.getEncounterId()){
                            ...
                            for(Map.Entry m: vitalSignMap.entrySet()){
                                ...
                                try {
                                    SimpleDateFormat simpleDateFormat = new SimpleDateFormat("MM/dd/yyyy");
                                    simpleDateFormat.format(vitalSigns.getDateOfVitals());
